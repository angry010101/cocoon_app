...
@Inject constructor(private var db: GithubDb, private var retroService: RetroService) : DataSource.Factory<Int, GithubUser>() {
    ...
    override fun create(): DataSource<Int, GithubUser> {
        ...
        val ds = TasksDataSource(db,retroService)
